...
# ... (Insertar aquí el código de creación de Layouts, Labels y Paneles de tu script original) ...
# [Nota: He omitido la repetición de los New-Object para brevedad, mantén tu lógica original de layout aquí]

# --- TIMER DE GESTIÓN DE JOBS (CORREGIDO) ---
